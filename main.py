...
class DSP:
    def __init__(self, i2c):
        ...
        self.filters = [[[0x00, 0xDF], [0x00, 0xE0], [0x00, 0xE1], [0x00, 0xE2], [0x00, 0xE3]],[[0x00, 0xE4], [0x00, 0xE5], [0x00, 0xE6], [0x00, 0xE7], [0x00, 0xE8]],[[0x00, 0xE9], [0x00, 0xEA], [0x00, 0xEB], [0x00, 0xEC], [0x00, 0xED]],[[0x00, 0xEE], [0x00, 0xEF], [0x00, 0xF0], [0x00, 0xF1], [0x00, 0xF2]], [[0x00, 0xF3], [0x00, 0xF4], [0x00, 0xF5], [0x00, 0xF6], [0x00, 0xF7]],[[0x00, 0xF8], [0x00, 0xF9], [0x00, 0xFA], [0x00, 0xFB], [0x00, 0xFC]]]
    ...
    def EQ_test(self):
        ...
        self.filter_safeload_write(3, [0x00, 	0x96, 	0xF0, 	0xE8], [0xFF, 	0x21, 	0xAD, 	0xDA], [0x00, 	0x53, 	0xD6, 	0xF3], [0x00, 	0xDE, 	0x52, 	0x26], [0xFF, 	0x95, 	0x38, 	0x26])
        self.filter_safeload_write(6, [0x00, 	0x7B, 	0x30, 	0xA6], [0xFF, 	0x0E, 	0x96, 	0x3F], [0x00, 	0x76, 	0xBD, 	0xB6], [0x00, 	0xF1, 	0x69, 	0xC1], [0xFF, 	0x8E, 	0x11, 	0xA4])
...
i2c.mem_write(0x00,0x20,0x03)
gpio_int = pyb.ExtInt('A14', pyb.ExtInt.IRQ_RISING, pyb.Pin.PULL_NONE, a)
def button():
